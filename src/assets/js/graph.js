...
async function _links(d3,FileAttachment){
  return(
...
export default function define(runtime, observer) {
  ...
  const fileAttachments = new Map([
    [
      ...
      {
        url: new URL(
          "./files/63c4d2f34c05d62a116fc16daf04215d82790c6bd036ce5783f7d002c5d83f704798ae8d61da50e2cc4cb81af8f629e4b14cc82abeeffd789a0cd425072cf2e6.csv",
          import.meta.url
        ),
        mimeType: "text/csv",
        toString
